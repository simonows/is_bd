...
<head>
  ...
  <title>Модуль "Новости вакансий"</title>
  <style>
    .carousel-item{
      height: 450px;
      width: 900px;
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">Модуль "Новости вакансий"</a>
          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="d-block img-fluid" src="https://tennisacadem.ru/images/003/100/279/3100279/1920x/vaka-1.png" alt="First slide">
                <div class="carousel-caption d-none d-md-block">
                  <p>Требуются новые сотрудники!!!</p>
                </div>
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="https://avatars.mds.yandex.net/get-pdb/2412470/a9a8c29e-6720-4a4b-9e9e-40091b38267e/s1200?webp=false" alt="Second slide">
                <div class="carousel-caption d-none d-md-block">
                  <p>Приглашаем принять участие в собеседовании!!!</p>
                </div>
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="https://avatars.mds.yandex.net/get-pdb/1244951/8b39a011-8200-43f1-9ac0-43c3360b5ee0/s1200?webp=false" alt="Second slide">
                <div class="carousel-caption d-none d-md-block">
                  <p>До 20 новых сотрудников планируется нанять !</p>
                </div>
              </div>
            </div>
